...
assert(html.includes('>v3.7.3<'), 'panel version is not v3.7.3');
assert(/ExtensionBundleVersion="3\.7\.3"/.test(manifest), 'bundle version is not 3.7.3');
assert(/Version="3\.7\.3"/.test(manifest), 'extension version is not 3.7.3');
